...
function runSelenium() {
  ...
  var cmd = 'node ./selenium/selenium_js_benchmark.js -f selenium_js_bench.csv -u http://127.0.0.1:8085/javascript_benchmark/blank.html';
...
function runPuppeteer() {
  var cmd = "node ./puppeteer/puppeteer_js_benchmark.js -f puppeteer_js_bench.csv -u http://127.0.0.1:8085/javascript_benchmark/blank.html";
...
function runCasper() {
  ...
  var cmd = "./casper/casperjs_js_benchmark.js -f casper_js_bench.csv -u http://127.0.0.1:8085/javascript_benchmark/blank.html";
