...
function runSelenium() {
  ...
  var cmd = 'node ./selenium/selenium_css_benchmark.js -f selenium_intensive_css_rules_benchmark.csv -u http://127.0.0.1:8085/css_benchmark_pages/intensive_css_rules.html';
...
function runPuppeteer() {
  var cmd = "node ./puppeteer/puppeteer_css_benchmark.js -f puppeteer_intensive_css_rules_benchmark.csv -u http://127.0.0.1:8085/css_benchmark_pages/intensive_css_rules.html";
...
function runCasper() {
  ...
  var cmd = "./casper/casperjs_css_benchmark.js -f casperjs_intensive_css_rules_benchmark.csv -u http://127.0.0.1:8085/css_benchmark_pages/intensive_css_rules.html";
